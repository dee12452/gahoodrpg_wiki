        ...
        Column(
          ...
          children: [
            ...
            const ProgressionDescription(
              description:
              'As you load into the world, your best bet at immediate survival is to get yourself into a tier 1 biome.'
                  ' Once there, get yourself the basic resources: wood, coal, stone and iron.'
            ...
            const ProgressionDescription(
              description:
              'From here you\'ll want to make a Forging Furnace.'
            ...
            const ProgressionDescription(
              description: 'Once you have at least one piece of tier 1 armor, you\'ll want to start taking on hordes.'
            ...
            const ProgressionDescription(
              description: 'With at least 2 pieces of tier 1 armor and a diamond weapon for your class, you may be ready to take on the boss.'
                  ' You will need to find a boss spawner undergound, and provide it with a Seed of Rage to spawn the boss.',
            ),
            const ProgressionDescription(
              description: 'The boss will drop Rage Essence, which you can use to make your tier 1 weapon.'
